...
const pillars = [
    {
        ...
        icon: Compass,
        description: "Curation ensures that each journey is thoughtfully crafted to reflect your personal aspirations and goals. It’s not random travel, it’s a purposeful path that helps you grow and discover.",
    ...
    },
    {
        ...
        icon: Users,
        description: `Community connects you with others on similar journeys. You learn from each other’s experiences and share in a larger collective vision, making the experience richer.
`,
        bgClass: "bg-blue-50",
    ...
    },
    {
        ...
        icon: Infinity,
        description: "Continuity means the Yatra doesn’t stop when the trip ends. What you experience continues to shape you and the collective journey ahead. Each step feeds into the next, keeping the vision of Viksit Bharat alive in your life.",
        bgClass: "bg-green-50",
